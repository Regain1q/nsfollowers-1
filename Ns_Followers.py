...
class Ns_Followers:
    def __init__(self):
        ...
        self.__username='nazanin._najafi6168' #Enter UserName Here
        self._session='66439659683:nqKUIn1awkZFTj:18:AYcftgasDHFRZPOqIoTfrxA50w6LDujprtuSfGld2g' #Enter SessionID Here
